	...
	return apply_filters(
		'softme_slider_options_default', json_encode(
				...
				array(
					...
					'video_url'       => esc_url(desert_companion_plugin_url . '/inc/themes/softme/assets/images/banner/slider_video.mp4'),
				...
				array(
					...
					'link3'	  =>  esc_html__( 'https://youtu.be/MLpWrANjFbI', 'desert-companion' ),
					"slide_align" => "right", 
					'subtitle2'         => esc_html__( 'Request a call back', 'desert-companion' ),
